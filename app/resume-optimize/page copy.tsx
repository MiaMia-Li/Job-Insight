                            ...
                            <div className="rounded-lg bg-muted p-3">
                              ...
                              <ul className="ml-5 list-disc space-y-1 text-sm text-muted-foreground">
                                ...
                                {metric.name === "Keyword Optimization" && (
                                  <>
                                    <li>
                                      Missing important industry-specific
                                      keywords
                                    </li>
                                    <li>
                                ...
                                {metric.name === "ATS Compatibility" && (
                                  <>
                                    ...
                                    <li>
                                      Complex tables or graphics may not be
                                      parsed correctly
                                    </li>
                                  </>
                                )}
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="rounded-lg border border-border p-4">
                        ...
                        <p className="text-sm text-muted-foreground">
                          ...
                          and your skills section needs expansion.
                        </p>
                        <Button
                          variant="link"
                          className="mt-2 h-auto p-0 text-sm text-primary"
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-sm text-muted-foreground">
                            Your resume is{" "}
                            {resumeData.score.overall < 76 ? "below" : "near"}{" "}
                            the industry average. Applying our optimization
                            suggestions can significantly improve your chances
              ...
              <Card>
                ...
                <CardContent>
                  <div className="mb-4 flex items-center justify-between rounded-lg bg-muted p-4">
                    ...
                    <Progress
                      value={
                        (totalAcceptedSuggestions / totalSuggestions) * 100
                      }
                      className="h-2 w-32"
                    />
                  </div>
                  ...
                  <Tabs defaultValue="content" className="w-full">
                    ...
                    <TabsContent value="content" className="space-y-4">
                      {resumeData.suggestions.content.map(
                        (suggestion, index) => (
                          <motion.div
                            key={`content-${index}`}
                                ...
                                <Dialog>
                                  ...
                                  <DialogContent className="max-w-2xl">
                                    <DialogHeader>
                                      ...
                                      <DialogDescription>
                                        See how this suggestion improves your
                                        resume
                                      </DialogDescription>
                                    </DialogHeader>
                            ...
                            <div className="flex items-center space-x-2">
                              <Button
                                ...
                                onClick={() =>
                                  toggleSuggestion("content", index)
                                }>
                                {acceptedSuggestions.content.includes(index) ? (
                          ...
                          <motion.div
                            ...
                            <div className="flex items-center space-x-2">
                              <Button
                                ...
                                {acceptedSuggestions.keywords.includes(
                                  index
                                ) ? (
                                  <Check className="h-4 w-4" />
                                ) : (
                    ...
                    <TabsContent value="format" className="space-y-4">
                      {resumeData.suggestions.format.map(
                        (suggestion, index) => (
                          <motion.div
                            key={`format-${index}`}
                            initial={{ opacity: 0, y: 10 }}
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-sm text-muted-foreground">
                            ...
                            are 3x more likely to result in interview
                            invitations. The suggested optimizations address the
                            key areas that hiring managers and ATS systems
                            prioritize.
                          </p>
                        </div>
                      </div>
              ...
              {!optimizationApplied ? (
                <div className="flex flex-col items-center justify-center rounded-lg border border-dashed py-12">
                  ...
                  <p className="mt-2 max-w-md text-center text-sm text-muted-foreground">
                    ...
                    resume. Select suggestions from the Optimization tab and
                            ...
                            <div className="rounded-lg border border-green-500/30 bg-green-50/50 p-4 dark:bg-green-900/5">
                              <div className="space-y-4">
                                ...
                                <div className="rounded-md bg-green-100/50 p-2 dark:bg-green-900/10">
                                  <p className="text-sm">
                                    Results-driven Sales Manager with 5+ years
                                    of experience leading high-performing teams
                                    and exceeding revenue targets in the SaaS
                                  ...
                                  <div className="mt-2">
                                    ...
                                    <ul className="mt-1 list-disc pl-5 text-sm">
                                      ...
                                      <li className="rounded-md bg-green-100/50 p-1 dark:bg-green-900/10">
                                        ...
                                        improved lead qualification efficiency
                                        by 35%
                                      </li>
                                      <li>
                                ...
                                <div>
                                  ...
                                  <p className="mt-1 text-sm rounded-md bg-green-100/50 p-2 dark:bg-green-900/10">
                                    ...
                                    (Salesforce, HubSpot), Data Analysis,
                                    Project Management, Team Leadership, Client
                              ...
                              <div className="mt-3">
                                ...
                                <ul className="mt-2 list-disc pl-5 text-sm">
                                  <li>
                                    ...
                                    increasing quarterly sales by 27% and
                      ...
                      <div className="rounded-lg bg-muted p-4 w-full">
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            <p className="mt-1 text-sm text-muted-foreground">
                              Your resume is now optimized for your target
                              roles. Download it and start applying to jobs, or
                              make further edits to customize it for specific
                              positions.
                            </p>
